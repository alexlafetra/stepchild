...
function findWasmBinary() {
  return locateFile("headless.wasm");
}
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write, _emscripten_set_window_title ];
...
function assignWasmExports(wasmExports) {
  ...
  dynCall_iifi = dynCalls["iifi"] = createExportWrapper("dynCall_iifi", wasmExports["dynCall_iifi"], 4);
