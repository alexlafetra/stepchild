...
class StepchildGraphics{
  ...
  NoteCoords getNoteScreenCoords(Note& note, uint8_t track, SequenceRenderSettings& settings);
  NoteCoords getNoteScreenCoords(Note& note, uint8_t track);
  ...
  void ditherBackground(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1);
  ...
  /*-------------------------------------------
                  Fonts -- these are implemented in a super janky way!
  -------------------------------------------*/
  ...
  // #define UP 2
  // #define DOWN 3
  void drawArrow(uint8_t pointX, uint8_t pointY, uint8_t size, ArrowDirection direction, bool full);
  void drawArrow(uint8_t pointX, uint8_t pointY, uint8_t size, ArrowDirection direction, uint8_t fillColor, uint8_t highlightColor, bool drawHighlight);
  void drawHighlightArrow(uint8_t pointX,uint8_t pointY, uint8_t size, ArrowDirection direction);
  ...
  void drawSlider(uint8_t x, uint8_t y, std::vector<String> &options, uint8_t which);
  ...
  void drawtinyPram_bmp(uint8_t x, uint8_t y);
  ...
  void drawFullKeyBed(uint8_t y1, std::vector<uint8_t> pressList, std::vector<uint8_t> mask, uint8_t activeKey,uint8_t octave);
  void drawFullKeyBed(std::vector<uint8_t> pressList, std::vector<uint8_t> mask, uint8_t activeKey,uint8_t octave);
