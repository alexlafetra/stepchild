...
extern const uint8_t NUMBER_OF_APPLICATIONS = 6;
extern const uint8_t NUMBER_OF_GENERATIVE_INSTRUMENTS = 2;

extern const String instrumentApplicationInfo[NUMBER_OF_APPLICATIONS] = {
...
extern bool (*const instrumentApplicationFunctions[NUMBER_OF_APPLICATIONS])() = {
...
extern const String instrumentApplicationTitles[NUMBER_OF_APPLICATIONS] = {
...
extern const uint8_t NUMBER_OF_FX = 8;

extern const String fxApplicationInfo[NUMBER_OF_FX] = {
    FX_APP1_INFO,
    FX_APP2_INFO,
    FX_APP3_INFO,
    FX_APP4_INFO,
...
//loading all the functions
extern bool (*const fxApplicationFunctions[NUMBER_OF_FX])() = {
    FX_APP1_FUNCTION,
    FX_APP2_FUNCTION,
    FX_APP3_FUNCTION,
    FX_APP4_FUNCTION,
...
extern const String fxApplicationTitles[NUMBER_OF_FX] = {
    FX_APP1_TEXT,
    FX_APP2_TEXT,
    FX_APP3_TEXT,
    FX_APP4_TEXT,
